...
//        json.put("port", deadSecondary.getPort());
    ...
    /**
     * When coordinator find out a new secondary, it will send this msg to primary
     * which will trigger checkpoint
     * @param newSecondary
     * @return
     */
    public static Message newSecondaryMemberMsgConstructor(String id, NetConfig newSecondary){
        JSONObject json = new JSONObject();
